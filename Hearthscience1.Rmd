...
p+ theme(axis.text.y = element_text(vjust = 1, 
                                    size = 3, hjust = 1))+theme(axis.text.x = element_text(angle = 45, vjust = 1, 
                                                                                           size = 2, hjust = 1))+scale_x_discrete(expand = c(0, 0)) + scale_y_discrete(expand = c(0, 0))+theme(legend.background=element_rect(),legend.margin=unit(1,"cm"))
