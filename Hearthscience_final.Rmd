...
```{r}
qplot(factor(data$mechanics),data$cost,geom="boxplot")+scale_fill_brewer()+theme(axis.text.x = element_text(angle = 45, hjust = 1,size=10))+ggtitle("Boxplots for cost in mechanics")+ylab("cost")

qplot(factor(data$mechanics),data$health,geom="boxplot")+scale_fill_brewer()+theme(axis.text.x = element_text(angle = 45, hjust = 1,size=10))+ggtitle("Boxplots for health in mechanics")+ylab("health")

qplot(factor(data$mechanics),data$attack,geom="boxplot")+scale_fill_brewer()+theme(axis.text.x = element_text(angle = 45, hjust = 1,size=10))+ggtitle("Boxplots for Attack in mechanics")+ylab("attack")
...
```{r}
qplot(factor(data$cardSet),data$cost,geom="boxplot")+scale_fill_brewer()+theme(axis.text.x = element_text(angle = 45, hjust = 1,size=10))+ggtitle("Boxplots for cost in CardSet")+ylab("cost")

qplot(factor(data$cardSet),data$health,geom="boxplot")+scale_fill_brewer()+theme(axis.text.x = element_text(angle = 45, hjust = 1,size=10))+ggtitle("Boxplots for health in CardSet")+ylab("health")

qplot(factor(data$cardSet),data$attack,geom="boxplot")+scale_fill_brewer()+theme(axis.text.x = element_text(angle = 45, hjust = 1,size=10))+ggtitle("Boxplots for Attack in CardSet")+ylab("attack")
...
1   Warlock   early   W       @ 8  mana

2   Warlock   early   W       @ 9  mana 

3   Mage      late  W       @ 7  mana

4   Mage      early   W       @ 7  mana

5   Hunter    late  W       @ 7  mana

6   Hunter    early   W       @ 7  mana

7   Warrior   early   W       @ 7  mana

8   Warrior   late  W       @ 8  mana

9   Shaman    late  W       @ 9  mana

10  Shaman    late  L       @ 8  mana

11  Druid     late  W       @ 6  mana

12  Druid     late  W       @ 6  mana 

13  Priest    early   W       @ 8  mana

14  Priest    late  W       @ 8  mana

15  Rogue     early   W       @ 7  mana

16  Rogue     early   W       @ 8  mana

17  Paladin   late  W       @ 6  mana

18  Paladin   early   L       @ 8  mana
...
4   Hunter    early   L       @ 7  mana

5   Paladin   late  L       @ 10 mana

6   Paladin   early   L     

7   Priest    early   L

8   Druid     early   L       @ 7  mana

9   Hunter    early   L       @ 10 mana

10  Warlock   early   L       @ 5  mana

11  Hunter    late  L       @ 6  mana