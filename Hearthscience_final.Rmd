...
The simulation results show that to have the probability of using card to be above 0.5 by the second turn, above 0.9 by the third turn, and above 0.95 by the fourth turn, and to have at least 10 high-cost cards, we need to have at least 2 cards with no more than 2 cost, 6 cards with no more than 3 cost, and 7 cards with no more than 4 cost.
